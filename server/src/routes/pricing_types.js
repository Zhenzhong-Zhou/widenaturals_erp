...
router.get('/', authorize(['view_prices', 'manage_prices']), getPriceTypesController);

/**
 * GET /pricing-types/details
 * Fetch all pricing type details with associated products and locations.
 */
router.get('/:id', authorize(['view_prices', 'manage_prices']), getPricingTypeDetailsByIdController);
