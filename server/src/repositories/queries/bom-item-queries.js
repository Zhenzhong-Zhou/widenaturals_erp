/**
 * @file bom-item-queries.js
 * @description SQL query constants for bom-item-repository.js.
 *
 * Exports:
 *  - BOM_ITEM_MATERIAL_SUPPLY_DETAILS — full supply chain detail by bom_id
 */

'use strict';

// Full supply chain projection — joins bom_items through to packaging material
// batches, suppliers, and all audit user fields.
// $1: bom_id (UUID)
const BOM_ITEM_MATERIAL_SUPPLY_DETAILS = `
  SELECT
    bi.bom_id,
