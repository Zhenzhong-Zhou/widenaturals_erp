...
const PRODUCT_BATCH_EDIT_RULES = {
   ...
   */
  received: ['received_at', 'received_by', 'notes', 'status_id', 'status_date'],
...
const PRODUCT_BATCH_STATUS_TRANSITIONS = {
   ...
   */
  pending: ['received', 'quarantined', 'rejected'],

  /**
   * Batch received into warehouse inventory.
   */
  received: ['quarantined', 'released', 'rejected'],

  /**
   * Batch temporarily blocked for QA inspection.
   */
  quarantined: ['released', 'rejected', 'suspended'],

  /**
   * Batch approved for operational use.
   */
  released: ['consumed', 'expired', 'suspended', 'archived'],

  /**
   * Suspended batches blocked due to QA or operational issues.
   */
  suspended: ['quarantined', 'released', 'archived'],
...
const PRODUCT_BATCH_PERMISSION_FIELD_RULES = {
   ...
   */
  edit_batch_metadata_sensitive: ['initial_quantity', 'received_at'],
