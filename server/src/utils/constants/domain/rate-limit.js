const { FIFTEEN_MINUTES, ONE_MINUTE, FIVE_MINUTES, TEN_MINUTES } = require('../general/time');
const { RATE_LIMIT_GLOBAL, RATE_LIMIT_API, RATE_LIMIT_LOGIN, RATE_LIMIT_AUTHENTICATION, RATE_LIMIT_AUTHORIZATION,
  RATE_LIMIT_PASSWORD_RESET, RATE_LIMIT_SIGNUP, RATE_LIMIT_ADMIN, RATE_LIMIT_FILE_UPLOAD, RATE_LIMIT_FORGOT_USERNAME
