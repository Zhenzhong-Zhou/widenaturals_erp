const ERROR_MESSAGES = {
  ...
  RATE_LIMIT_FILE_UPLOAD: 'Too many file upload requests. Please try again later.',
  RATE_LIMIT_FORGOT_USERNAME: 'Too many forgot username requests. Please try again later.',
};
