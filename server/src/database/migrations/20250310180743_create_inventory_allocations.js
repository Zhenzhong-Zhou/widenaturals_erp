...
exports.up = function (knex) {
  return knex.schema.createTable("inventory_allocations", (table) => {
    ...
    table.uuid("status_id").references("id").inTable("inventory_allocation_status").notNullable();
    ...
    table.uuid("transfer_id").references("id").inTable("inventory_transfers").nullable();
