...
exports.up = async function (knex) {
  ...
  await knex.schema.createTable('sku_compliance_links', (table) => {
    ...
    table.uuid('sku_id').notNullable().references('id').inTable('skus').onDelete('CASCADE');
    table.uuid('compliance_record_id')
      .notNullable()
      .references('id')
    ...
    table.unique(['sku_id', 'compliance_record_id'], 'unique_sku_compliance_link');
