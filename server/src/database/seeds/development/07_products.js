...
exports.seed = async function (knex) {
  ...
  const products = [
    ...
    },
    {
      ...
      height_cm: 2.00,
      weight_g: 200.00,
      description: 'A set of reusable, eco-friendly silicone food bags for storage.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
    ...
    },
    {
      ...
      height_cm: 6.00,
      weight_g: 300.00,
      description: 'A pack of natural wool dryer balls for a sustainable laundry experience.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
    ...
    },
    {
      ...
      height_cm: 10.00,
      weight_g: 800.00,
      description: 'Compostable coffee pods compatible with popular coffee machines.',
    ...
    },
    {
      ...
      height_cm: 7.00,
      weight_g: 550.00,
      description: 'A reusable glass water bottle made from recycled materials.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
    ...
    },
    {
      ...
      height_cm: 0.50,
      weight_g: 1200.00,
      description: 'A non-toxic, eco-friendly yoga mat for sustainable workouts.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
    ...
    },
    {
      ...
      height_cm: 1.00,
      weight_g: 100.00,
      description: 'Soft and reusable makeup remover pads made from organic cotton.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
    ...
    },
    {
      ...
      height_cm: 0.50,
      weight_g: 800.00,
      description: 'Solar-powered LED string lights for eco-friendly home decor.',
      status_id: activeStatusId,
      status_date: knex.fn.now(),
      created_at: knex.fn.now(),
      updated_at: knex.fn.now(),
