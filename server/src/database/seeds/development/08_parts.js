...
exports.seed = async function (knex) {
  ...
  const parts = [
    {
      ...
      description:
        'Clear vegetable-based capsule for encapsulating powder or softgel',
    },
    {
      ...
      unit_of_measure: 'piece',
      description:
        'Pre-filled gelatin-based softgel capsule containing active ingredients, ready for bottling',
    },
    {
      name: 'Printed Label',
      code: 'LBL-STD',
    ...
    },
    {
      ...
      unit_of_measure: 'piece',
      description:
        '3-part telescoping box with lid, tray insert, and base as one assembled unit',
    },
    {
      ...
      unit_of_measure: 'piece',
      description:
        'Foil-based seal that indicates if the product has been opened',
    },
    {
      ...
      unit_of_measure: 'piece',
      description:
        'Foam liner designed to fit threaded caps, providing a secure seal to prevent leakage and protect bottle contents.',
    },
    {
      name: 'Desiccant',
      code: 'DSC-PACKET',
    ...
    },
    {
      ...
      unit_of_measure: 'piece',
      description:
        'Cap-mounted insert with integrated desiccant for moisture control in packaging',
    },
    {
      name: 'Filler',
      code: 'PART-FILLER',
      ...
      unit_of_measure: 'piece',
      description:
        'Generic filler material used to stabilize or protect contents during packaging',
    },
    {
      name: 'Bottle',
      code: 'PART-BOTTLE',
      ...
      unit_of_measure: 'piece',
      description:
        'Generic container used to hold product in solid or liquid form',
    },
    {
      name: 'Lid',
      code: 'PART-LID',
  ...
  await knex('parts').insert(records).onConflict('code').ignore();
