...
exports.seed = async function (knex) {
  ...
  const permissions = [
    ...
    { name: 'View Batch Registry Dropdown', key: 'view_batch_registry_dropdown', description: 'Allows access to batch registry dropdown data' },
    { name: 'View Warehouse Lookup', key: 'view_warehouse_lookup', description: 'Allows accessing the warehouse lookup list' },
    ...
    { name: 'View Order Type', key: 'view_order_type', description: 'Allows viewing order type dropdowns' },
