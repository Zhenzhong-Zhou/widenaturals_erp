...
exports.seed = async function (knex) {
  ...
  const lotData = [
    { product: 'Focus - CA', lot_number: 'UNASSIGNED-11000001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 2 },
    { product: 'Focus - CA', lot_number: '11000004', expiry_date: '2026-02-13', warehouse: 'Head Office Warehouse', quantity: 84 },
    { product: 'Focus - INT', lot_number: 'UNASSIGNED-11000001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 8 },
    { product: 'Focus - INT', lot_number: '11000002', expiry_date: '2025-08-24', warehouse: 'Head Office Warehouse', quantity: 6 },
    
    { product: 'Gut Health - CA', lot_number: '11100004', expiry_date: '2026-01-20', warehouse: 'Head Office Warehouse', quantity: 27 },
    { product: 'Gut Health - CA', lot_number: '11100005', expiry_date: '2026-08-11', warehouse: 'Head Office Warehouse', quantity: 12 },
    { product: 'Gut Health - INT', lot_number: 'UNASSIGNED-11100001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 4 },
    
    { product: 'Hair Health', lot_number: 'NTFS2E003', expiry_date: '2027-11-20', warehouse: 'Head Office Warehouse', quantity: 124 },
    
    { product: 'Immune - CA', lot_number: 'UNASSIGNED-11300001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 10 },
    { product: 'Immune - CA', lot_number: '11300003', expiry_date: '2026-02-14', warehouse: 'Head Office Warehouse', quantity: 29 },
    { product: 'Immune - CA', lot_number: '11300004', expiry_date: '2026-04-05', warehouse: 'Head Office Warehouse', quantity: 105 },
    { product: 'Immune - CA', lot_number: 'CM78737', expiry_date: '2027-08-25', warehouse: 'Head Office Warehouse', quantity: 100 },
    { product: 'Immune - INT', lot_number: '11300001', expiry_date: '2025-08-25', warehouse: 'Head Office Warehouse', quantity: 1 },
    { product: 'Immune - INT', lot_number: '11300002', expiry_date: '2025-12-21', warehouse: 'Head Office Warehouse', quantity: 2 },
    { product: 'Immune - INT', lot_number: '11300004', expiry_date: '2026-04-05', warehouse: 'Head Office Warehouse', quantity: 8 },
    
    { product: 'Memory - CA', lot_number: 'UNASSIGNED-11400001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 10 },
    { product: 'Memory - CA', lot_number: '11400001', expiry_date: '2025-08-10', warehouse: 'Head Office Warehouse', quantity: 12 },
    { product: 'Memory - CA', lot_number: '11400003', expiry_date: '2026-01-24', warehouse: 'Head Office Warehouse', quantity: 32 },
    { product: 'Memory - INT', lot_number: 'UNASSIGNED-11400001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 12 },
    { product: 'Memory - INT', lot_number: '11400003', expiry_date: '2026-01-25', warehouse: 'Head Office Warehouse', quantity: 39 },
    { product: 'Memory - INT', lot_number: '11400004', expiry_date: '2026-08-10', warehouse: 'Head Office Warehouse', quantity: 8 },
    
    { product: 'Menopause - CA', lot_number: 'UNASSIGNED-11500001', expiry_date: '2026Mar07', warehouse: 'Head Office Warehouse', quantity: 10 },
    { product: 'Menopause - CA', lot_number: '11500002', expiry_date: '2026-07-05', warehouse: 'Head Office Warehouse', quantity: 41 },
    { product: 'Menopause - INT', lot_number: 'UNASSIGNED-11800001', expiry_date: '2025Oct20', warehouse: 'Head Office Warehouse', quantity: 8 },
    { product: 'Menopause - INT', lot_number: '11800003', expiry_date: '2026-02-16', warehouse: 'Head Office Warehouse', quantity: 7 },
    
    { product: 'Mood - CA', lot_number: 'UNASSIGNED-12800001', expiry_date: '2026Mar20', warehouse: 'Head Office Warehouse', quantity: 4 },
    { product: 'Mood - CA', lot_number: '12800001', expiry_date: '2026-03-20', warehouse: 'Head Office Warehouse', quantity: 82 },
    { product: 'Mood - INT', lot_number: 'UNASSIGNED-11900001', expiry_date: '2026Mar20', warehouse: 'Head Office Warehouse', quantity: 3 },
    { product: 'Mood - INT', lot_number: '11900004', expiry_date: '2026-08-03', warehouse: 'Head Office Warehouse', quantity: 71 },
    
    { product: 'Sleep - CA', lot_number: 'DAMAGED-11200003', expiry_date: '2026-05-10', warehouse: 'Head Office Warehouse', quantity: 6 },
    { product: 'Sleep - CA', lot_number: 'SUSPENDED-11200004', expiry_date: '2026-07-11', warehouse: 'Head Office Warehouse', quantity: 53 },
    { product: 'Sleep - CA', lot_number: 'CS86736', expiry_date: '2027-08-11', warehouse: 'Head Office Warehouse', quantity: 30 },
    
    { product: 'NMN 3000 - CA', lot_number: '12000004', expiry_date: '2026-04-24', warehouse: 'Head Office Warehouse', quantity: 91 },
    { product: 'NMN 3000 - INT', lot_number: '12000004', expiry_date: '2026-04-24', warehouse: 'Head Office Warehouse', quantity: 11 },
    { product: 'NMN 3000 - INT', lot_number: '12000005', expiry_date: '2026-07-20', warehouse: 'Head Office Warehouse', quantity: 100 },
    
    { product: 'NMN 6000 - CA', lot_number: '12100003', expiry_date: '2025-11-23', warehouse: 'Head Office Warehouse', quantity: 18 },
    { product: 'NMN 6000 - CA', lot_number: '12100004', expiry_date: '2026-04-18', warehouse: 'Head Office Warehouse', quantity: 72 },
    { product: 'NMN 6000 - INT', lot_number: '12100004', expiry_date: '2026-04-18', warehouse: 'Head Office Warehouse', quantity: 55 },
    
    { product: 'NMN 10000 - CA', lot_number: '12200005', expiry_date: '2026-03-07', warehouse: 'Head Office Warehouse', quantity: 1 },
    { product: 'NMN 10000 - INT', lot_number: '12200008', expiry_date: '2027-03-05', warehouse: 'Head Office Warehouse', quantity: 88 },
    
    { product: 'NMN 15000 - CA', lot_number: '12300012', expiry_date: '2027-02-13', warehouse: 'Head Office Warehouse', quantity: 14 },
    { product: 'NMN 15000 - INT', lot_number: '12300013', expiry_date: '2027-05-15', warehouse: 'Head Office Warehouse', quantity: 33 },
    { product: 'NMN 15000 - INT', lot_number: '12300014', expiry_date: '2027-08-29', warehouse: 'Head Office Warehouse', quantity: 71 },
    
    { product: 'NMN 30000 - CA', lot_number: '12400007', expiry_date: '2026-03-02', warehouse: 'Head Office Warehouse', quantity: 3 },
    { product: 'NMN 30000 - INT', lot_number: 'VNN7E68C', expiry_date: '2027-09-18', warehouse: 'Head Office Warehouse', quantity: 419 },
    
    { product: 'Seal Oil - 120 Softgels', lot_number: 'NTSS2E002', expiry_date: '2027-10-20', warehouse: 'Head Office Warehouse', quantity: 200 },
    { product: 'Seal Oil - 180 Softgels', lot_number: 'NTSS2E001', expiry_date: '2027-10-20', warehouse: 'Head Office Warehouse', quantity: 89 },
