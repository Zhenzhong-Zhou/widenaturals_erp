...
exports.seed = async function (knex) {
  try {
    ...
    const taxRates = [
      { name: 'GST', rate: 5.00, province: null, region: 'Canada' },
      { name: 'PST', rate: 7.00, province: 'BC', region: 'Canada' },
      { name: 'PST', rate: 6.00, province: 'SK', region: 'Canada' },
      { name: 'PST', rate: 7.00, province: 'MB', region: 'Canada' },
      { name: 'QST', rate: 9.975, province: 'QC', region: 'Canada' },
      { name: 'HST', rate: 13.00, province: 'ON', region: 'Canada' },
      { name: 'HST', rate: 15.00, province: 'NB', region: 'Canada' },
      { name: 'HST', rate: 15.00, province: 'NS', region: 'Canada' },
      { name: 'HST', rate: 15.00, province: 'NL', region: 'Canada' },
      { name: 'HST', rate: 15.00, province: 'PE', region: 'Canada' },
      { name: 'Zero-Rated', rate: 0.00, province: null, region: 'Canada' }
    ];
    ...
    console.log(`${formattedTaxRates.length} tax_rate records seeded successfully.`);
  } catch (error) {
