...
exports.seed = async function (knex) {
  ...
  const rawPricingTypes = [
    ...
    },
    {
      ...
      description:
        'Special discounted pricing available exclusively to company employees.',
      status: 'active',
    },
    {
      name: 'Sample Price',
      description: 'Price for product samples for marketing/testing.',
      status: 'active',
    },
    {
    ...
    },
    {
      ...
      description: 'Exclusive pricing for members.',
      status: 'inactive',
    },
    {
      name: 'Bulk Purchase Discount',
      description: 'Discounts for bulk purchases.',
      status: 'inactive',
    },
  ];
  ...
  for (const entry of rawPricingTypes) {
    const statusId =
      entry.status === 'active' ? activeStatusId : inactiveStatusId;
    const code = generateStandardizedCode('PRC', entry.name, {
