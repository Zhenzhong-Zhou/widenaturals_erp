...
exports.seed = async function (knex) {
  ...
  const orderStatuses = [
    // DRAFT
    {
      ...
      code: 'ORDER_PENDING',
      category: 'draft',
      description: 'Order created but not reviewed.',
    },
    {
      name: 'Edited',
      code: 'ORDER_EDITED',
      category: 'draft',
      description: 'Order edited before confirmation.',
    },

    // CONFIRMATION
    {
      name: 'Awaiting Review',
      code: 'ORDER_AWAITING_REVIEW',
      category: 'confirmation',
      description: 'Order is pending approval from a reviewer.',
    },
    {
      name: 'Confirmed',
      code: 'ORDER_CONFIRMED',
      category: 'confirmation',
      description: 'Order confirmed for processing.',
    },
    ...
    // PROCESSING (covers allocation + fulfillment + shipping)
    {
      ...
      category: 'processing',
      description: 'Attempting to allocate inventory.',
    },
    {
      name: 'Partially Allocated',
      code: 'ORDER_PARTIALLY_ALLOCATED',
      category: 'processing',
    ...
    },
    {
      ...
      code: 'ORDER_PARTIALLY_FULFILLED',
      category: 'processing',
