...
(async () => {
  ...
  try {
    console.log(
      `${logPrefix} 🚀 Starting packaging material batch creation test...`
    );
    ...
    // ------------------------------------------------------------
    console.log(
      `${logPrefix} ▶️ Calling createPackagingMaterialBatchesService...`
    );
    ...
    console.log(
      `${logPrefix} ✅ Packaging material batches created successfully`
    );
