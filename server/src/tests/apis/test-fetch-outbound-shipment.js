...
const { fetchPaginatedOutboundFulfillmentService } = require('../../services/outbound-fulfillment-service');
...
(async () => {
  ...
  try {
    ...
    console.log(`${logContext} ▶️ Using sort key: ${logicalSortKey} → column: ${sortByColumn}`);
    ...
    console.log(`${logContext} ▶️ Running fetchPaginatedOutboundFulfillmentService...`);
    ...
    console.log(`${logContext} ▶️ Data Preview (first row):`, result.data?.[0] || 'No data');
