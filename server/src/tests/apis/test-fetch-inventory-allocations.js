...
const { fetchPaginatedInventoryAllocationsService } = require('../../services/inventory-allocation-service');
...
(async () => {
  ...
  try {
    ...
    console.error('[Test: fetchPaginatedInventoryAllocationsService] Error:', error.message);
