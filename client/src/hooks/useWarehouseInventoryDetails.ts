...
const useWarehouseInventoryDetails = (
  ...
  const [warehouseInventoryDetailPage, setWarehouseInventoryDetailPage] =
    useState<number>(initialPage);
  const [warehouseInventoryDetailLimit, setWarehouseInventoryDetailLimit] =
    useState<number>(initialLimit);

  // Redux state selectors
  const warehouseInventoryDetails = useAppSelector(
    selectWarehouseInventoryDetails
  );
  const warehouseInventoryDetailPagination = useAppSelector(
    selectWarehouseInventoryDetailPagination
  );
  const warehouseInventoryDetailLoading = useAppSelector(
    selectWarehouseInventoryDetailLoading
  );
  const warehouseInventoryDetailError = useAppSelector(
    selectWarehouseInventoryDetailError
  );
