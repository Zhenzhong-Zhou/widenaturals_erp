 ...
 * - Permission-based access control (static and dynamic)
 * - Navigation menu metadata (title and ordering)
 *
 * Dynamic permissions may be resolved from route params.
 * Returning `null` from a resolver indicates an invalid route
 * and will result in a 404 redirect.
 */
export const appRoutes: AppRoute[] = [
  ...
  defineRoute({
    ...
    meta: {
      requiresAuth: true,
      // permission optional here — add if you already enforce one elsewhere
  ...
  defineRoute({
    ...
    component: lazy(() => import('@features/warehouseInventory/pages/WarehouseInventoryPage')),
    meta: {
      requiresAuth: true,
      requiredPermission: 'view_warehouses',
  ...
  defineRoute({
    ...
    component: lazy(() => import('@features/inventoryAllocation/pages/InventoryAllocationsPage')),
    meta: {
      requiresAuth: true,
      requiredPermission: 'view_inventory_allocations',
  ...
  defineRoute({
    ...
    component: lazy(() => import('@features/report/pages/InventoryActivityLogsPage')),
    meta: {
      requiresAuth: true,
