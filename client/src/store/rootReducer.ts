...
import inventorySummaryReducer from '../features/inventory/state/inventorySummarySlice.ts';
...
import salesOrderDetailReducer from '../features/order/state/salesOrderDetailSlice.ts';
