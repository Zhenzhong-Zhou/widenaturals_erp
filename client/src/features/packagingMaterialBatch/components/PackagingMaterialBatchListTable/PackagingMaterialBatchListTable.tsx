...
interface PackagingMaterialBatchListTableProps {
  data: FlattenedPackagingMaterialBatchRow[];
  loading: boolean;
  page: number;
  rowsPerPage: number;
  totalPages: number;
...
/**
 * Table component for displaying packaging material batch records.
 *
 * Provides:
...
const PackagingMaterialBatchListTable = ({
  ...
  const renderExpandedContent = useCallback(
    (row: FlattenedPackagingMaterialBatchRow) => (
      ...
      >
        <PackagingMaterialBatchExpandedContent row={row} />
      </Suspense>
    ),
    []
  );
  ...
  return (
    <Box>
      ...
      <CustomTable
        ...
        emptyMessage="No packaging material batch records found"
      />
    </Box>
  );
};

export default PackagingMaterialBatchListTable;
