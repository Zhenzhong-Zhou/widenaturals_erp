...
import type { SkuProductCard, SkuProductCardFilters } from '@features/product/state';
    ...
    <Container>
      <Stack direction="column" spacing={2} mt={3}>
        ...
        <Stack direction="row" spacing={2} alignItems="center" flexWrap="wrap">
          <CustomButton onClick={() => refreshSkuCards(page, limit, filters)}>Refresh Product Cards</CustomButton>
          <GoBackButton />
        </Stack>
        
        {/* Filters */}
        <SkuProductCardFilterPanel filters={filters} onChange={handleFilterChange} />
