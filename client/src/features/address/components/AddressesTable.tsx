  ...
  const columns: Column<AddressListItem>[] = useMemo(() => {
    const base: Column<AddressListItem>[] = [
      ...
      },
      {
        ...
        label: 'Label',
        minWidth: 100,
        renderCell: (row) => formatLabel(row.label),
      },
      {
        id: 'recipientName',
        label: 'Recipient',
        minWidth: 120,
        renderCell: (row) => formatLabel(row.recipientName),
      },
      {
        id: 'city',
        label: 'City',
        minWidth: 100,
        renderCell: (row) => formatLabel(row.address.city),
      },
      {
        id: 'state',
        label: 'State',
        minWidth: 100,
        renderCell: (row) => toUpperCase(row.address.state),
      },
      {
        id: 'country',
        label: 'Country',
        minWidth: 100,
        renderCell: (row) => formatLabel(row.address.country),
      },
      {
        id: 'createdAt',
        label: 'Created At',
