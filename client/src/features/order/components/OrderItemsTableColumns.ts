...
export const orderItemsColumns = (items: FetchedOrderItem[]): Column<FetchedOrderItem>[] => {
  ...
  const hasAdjustedPrice = items.some(item =>
    item.adjusted_price && item.adjusted_price !== item.system_price
  );
  
  const columns: Column<FetchedOrderItem>[] = [
    { id: 'product_name', label: 'Product Name', minWidth: 150, sortable: true },
    { id: 'barcode', label: 'Barcode', minWidth: 150, sortable: true },
    { id: 'npn', label: 'NPN', minWidth: 150, sortable: true },
    { id: 'quantity_ordered', label: 'Quantity Ordered', minWidth: 100, sortable: true },
    ...
    { id: 'order_item_status_name', label: 'Status', minWidth: 100, sortable: true },
    {
