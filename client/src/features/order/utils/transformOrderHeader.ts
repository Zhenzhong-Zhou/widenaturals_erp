import type { AuditUser, FlattenedOrderHeader, TransformedOrder } from '../state';
...
export const flattenSalesOrderHeader = (raw: TransformedOrder): FlattenedOrderHeader=> {
  ...
  return {
    ...
    discountAmount: raw.discount?.amount != null ? Number(raw.discount.amount) : null,
