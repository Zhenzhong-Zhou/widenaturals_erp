...
export const bomProductionReadinessSlice = createSlice({
  ...
  reducers: {
     ...
     */
    setProductionReadinessSelectedBomId: (state, action: PayloadAction<string | null>) => {
...
// Export actions
export const { resetBomProductionReadiness, setProductionReadinessSelectedBomId } =
