...
export function getInventoryDetailsFields(
  ...
  const details: DetailsSectionField[] = [
    ...
    { label: 'Manufacture Date', value: record.lot?.manufactureDate, format: formatDate },
  ...
  const metadata: DetailsSectionField[] = [
    ...
    { label: 'Created At', value: record.timestamps?.createdAt, format: formatDate },
    { label: 'Updated At', value: record.timestamps?.updatedAt, format: formatDate },
    { label: 'Inbound Date', value: record.timestamps?.inboundDate, format: formatDateTime },
    { label: 'Outbound Date', value: record.timestamps?.outboundDate, format: formatDateTime },
    { label: 'Last Update', value: record.timestamps?.lastUpdate, format: formatDate },
  ];
