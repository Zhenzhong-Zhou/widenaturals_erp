...
import { createCustomerThunk, createBulkCustomersThunk } from "./customerThunks";
...
const customerCreateSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createCustomerThunk.fulfilled, (state, action: PayloadAction<BulkCustomerResponse>) => {
        state.loading = false;
      ...
      .addCase(createBulkCustomersThunk.fulfilled, (state, action: PayloadAction<BulkCustomerResponse>) => {
        state.loading = false;
