...
const warehouseInventorySortOptions: {
  label: string;
  value: WarehouseInventorySortField;
}[] = [
  // ---- Product / item fields ----
...
const WarehouseInventorySortControls: FC<
  WarehouseInventorySortControlsProps
> = ({ sortBy, sortOrder, onSortByChange, onSortOrderChange }) => {
  return (
    <SortControls
      ...
      onSortByChange={(val) =>
        onSortByChange(val as WarehouseInventorySortField)
      }
